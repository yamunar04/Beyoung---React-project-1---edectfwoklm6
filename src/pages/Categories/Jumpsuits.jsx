    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          "https://academics.newtonschool.co/api/v1/ecommerce/clothes/products?filter={%22subCategory%22:%22jumpsuit%22,%20%22gender%22:%22Women%22}&limit=100",
          config
        );
